...
from planet.config.enums import UserActivationCodeStatus, ApplyStatus, AdminActionS
...
class CActivationCode(BASEAPPROVAL):
    ...
    def set_rule(self):
        ...
        with db.auto_commit():
            ...
            BASEADMIN().create_action(AdminActionS.insert.value, 'ActivationCodeRule', ActivationCodeRule.ACRid)
